...
3. **Invoke the chosen technique's skill** — each of the eight is installed as its own skill of the same name — **and follow it inline**, including its honesty mechanics. If the sibling skill is unavailable, fall back to the condensed core loop below and say that you are running the condensed version.
...
Use these only when the full sibling skill is not available.
...
*Source: [danium/lateral-thinking](https://github.com/danium/lateral-thinking), MIT licensed. Techniques drawn from Edward de Bono, Bob Eberle, William J.J. Gordon, and the d.school/IDEO toolkit.*
